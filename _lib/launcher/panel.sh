...
_specialized_fsClient() {
	"$HOME"/core/infrastructure/PanelBoard/_panel_place_app "$HOME"/core/infrastructure/PanelBoard/_dolphin_editFakeHome "$@"
	...
	#"$HOME"/core/infrastructure/PanelBoard/_panel_place_app "$HOME"/core/infrastructure/PanelBoard/_panelApp-dolphin_editHome "$@"
}
...
_panel_fsClient_desk() {
	...
	_messageNormal '***** _panel_fsClient_desk'
	_messagePlain_probe_var 1
	_messagePlain_probe_var currentDeskNumber
	
	if ! [[ "$currentDeskNumber" -ge 1 ]] || ! [[ "$currentDeskNumber" -le 18 ]]
	then
		_messagePlain_bad 'fail: currentDeskNumber out of bounds'
		return 1
	fi
...
export panelScriptAbsoluteLocation=$(_getScriptAbsoluteLocation)
export panelScriptAbsoluteFolder=$(_getScriptAbsoluteFolder)
